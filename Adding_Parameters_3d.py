...
oProject = oDesktop.SetActiveProject("Workshop_A9_") #Hier muss der Name der Datei angepasst werden!!!
oDesign = oProject.SetActiveDesign("Maxwell3DDesign1") #Und hier der ensprechende Design das vorhanden ist.
