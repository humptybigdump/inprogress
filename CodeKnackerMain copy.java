...
public class CodeKnackerMain {
	...
	public static void main(String[] args) {
		File eingabeOrdner = new File("geheime_Texte");
		File ausgabeOrdner = new File("entschluesselte_Texte");

		for (File geheimnachricht : eingabeOrdner.listFiles()) {
			...
			System.out.println("Entschluesselt: " + klartext);

			File klartextnachricht = new File(ausgabeOrdner.getPath() + File.separator + geheimnachricht.getName());
