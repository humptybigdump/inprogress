function [m,c,w,phi]= ModaleAnalyse2(M,C,x0,t)
...
phi1 = Phi(:,1:length(M)) ;
phi  = [phi1(:,1)/phi1(1,1)   phi1(:,2)/phi1(1,2)];
...
% Lösung in den generalisierten Koordinaten y(t)
y1 = y0(1,1)*cos(w(1,1)*t);
y2 = y0(2,1)*cos(w(2,2)*t);
subplot(2,1,1), plot(t,y1, t,y2,'r','LineWidth',2)
set(gca,'FontSize',16)
...
x1 = phi(1,1)*y1 + phi(1,2)*y2;
x2 = phi(2,1)*y1 + phi(2,2)*y2;
subplot(2,1,2), plot(t,x1, t,x2,'r','LineWidth',2)
set(gca,'FontSize',16)
