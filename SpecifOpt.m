function [time_format,time_units,ini_conc,mean_subs]=SpecifOpt(time_format1,time_units1,ini_conc1,mean_subs1)
...
hradionattracer = uicontrol('Style','radiobutton',...
     'String','Days','parent',hiniconcentrbuttongroup,...
     'Position',[9,32,139,23]);
hradioarttracer = uicontrol('Style','radiobutton',...
     'String','Hours','parent',hiniconcentrbuttongroup,...
