...
Params = np.array((3,1000,3,3,5,0.1,10))    # first resistivities, then thicknesses
VectorABHalf = np.linspace(1,1000)          # forward model uses Schlummberger Array
NumberOfMeasurements = len(VectorABHalf)
