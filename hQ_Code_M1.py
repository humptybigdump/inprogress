...
### M1: hQ-Beziehung und Durchflusszeitreihe ###
...
df = pd.read_csv('S1_hQ.csv', sep = '\t', decimal = ',', comment = '#')
...
ax[0].set_title('h-Q-Beziehung M1', fontsize = 25, pad = 12)
...
ax[1].set_title('Linearisierte h-Q-Beziehung M1', fontsize = 25, pad = 12)
...
#ax.set_title('Durchflusszeitreihe M1', fontsize = 25, pad = 12)
...
hs.to_csv('M1_Durchflusszeitreihe.csv', index = True) # Index wird mit exportiert
