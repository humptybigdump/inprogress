...
### M2: hQ-Beziehung und Durchflusszeitreihe ###
...
df = pd.read_csv('S2_hQ.csv', sep = '\t', decimal = ',', comment = '#')
...
ax[0].set_title('h-Q-Beziehung M2', fontsize = 25, pad = 12)
...
ax[1].set_title('Linearisierte h-Q-Beziehung M2', fontsize = 25, pad = 12)
...
#ax.set_title('Durchflusszeitreihe M2', fontsize = 25, pad = 12)
...
hs.to_csv('M2_Durchflusszeitreihe.csv', index = True)   # Index wird mit exportiert
