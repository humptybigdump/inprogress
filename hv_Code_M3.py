...
### M3: hv-Beziehung und Geschwindigkeitszeitreihe ###
...
df = pd.read_csv('S3_hv.csv', sep = '\t', comment = '#', decimal = ',') # Separator ; Kommazeichen .
...
ax[0].set_title('h-v-Beziehung M3', fontsize = 25, pad = 12)
...
ax[1].set_title('Linearisierte h-v-Beziehung M3', fontsize = 25, pad = 12)
...
#ax.set_title('Geschwindigkeitszeitreihe M3', fontsize = 25, pad = 12)
...
hs.to_csv('M3_Geschwindigkeitszeitreihe.csv', index = False)  # 'index = False' entfernt die Indexspalte
