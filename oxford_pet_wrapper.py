...
class OxfordPetDataset(Dataset):
    def __init__(self, images_dir: str, mask_dir: str):
        ...
        self.ids = [
            ...
            if len(self.load_image(self.images_dir / f"{img_id}.jpg").split()) not in [1, 4]
        ]
        ...
        for img_id in tqdm(self.ids):
            unique_values = self.unique_mask_values(img_id, self.mask_dir)
    ...
    def unique_mask_values(self, idx, mask_dir):
