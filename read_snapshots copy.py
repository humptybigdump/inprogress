...
# in the reference file the label of the columns are (from left to right) "y/h", "y+", "U+", "u'+","v'+","w'+","-Om_z+","omx+","omy+","omz+","uv+","uw+","vw+","pr+","ps+","psto+","p'+"

referece_data=np.genfromtxt("Re180",delimiter="  ",skip_header=1)
yh=reference_data[:,0]# reading the first column (y grid)
U_plus=reference_data[:,2] # mean velocity profile "U+"
