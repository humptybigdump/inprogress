...
# Anmerkung: Die interaktiven Graphiken funktionieren nur, wenn unter Werkzeuge - Einstellungen - IPython-Konsole - Graphik das Graphik-Backend auf Automatisch eingestellt ist 
#            gegebenenfalls muss pip install mplcursors installiert werden
...
points, = plt.plot(df_paar_nacht['Saettigungsdefizitmittelwert'],df_paar_nacht['r_tot'],'.', markersize=3) # Points definieren fuer interaktive Graphik
...
# Interaktive Graphik mit Curseranzeige zu den Datenpunkten erstellen
cursor = mplcursors.cursor(points, hover=True)

@cursor.connect("add")
def on_add(sel):
    i = sel.index
    x_val = df_paar_nacht['Saettigungsdefizitmittelwert'].iloc[i]
    y_val = df_paar_nacht['r_tot'].iloc[i]
    t_val = df_paar_nacht['Zeit_mittel'].iloc[i]   # Info Zeitstempel zum Datenpunkt
...
points, = plt.plot(df_paar_tag['Strahlung'],df_paar_tag['r_photo'],'.',markersize=3) # Points definieren fuer interaktive Graphik
...
def on_add(sel):
    i = sel.index
    x_val = df_paar_tag['Strahlung'].iloc[i]
    y_val = df_paar_tag['r_photo'].iloc[i]
    t_val = df_paar_tag['Zeit_mittel'].iloc[i]   # Info Zeitstempel zum Datenpunkt
...
# Plot mit linearer Regression erstellen
plt.figure(figsize=(9,6))
points, = plt.plot(df_paar_nacht_13['Saettigungsdefizitmittelwert'],df_paar_nacht_13['r_tot'],'.',markersize=3) # Points definieren fuer interaktive Graphik
plt.plot(x,y,label=f'Regression: y = {k2:.2e}x + {r_zehr:.2e}',color='purple')
plt.tick_params(axis='both',labelsize=13) 
...
def on_add(sel):
    i = sel.index
    x_val = df_paar_nacht_13['Saettigungsdefizitmittelwert'].iloc[i]
    y_val = df_paar_nacht_13['r_tot'].iloc[i]
    t_val = df_paar_nacht_13['Zeit_mittel'].iloc[i]   # Info Zeitstempel zum Datenpunkt
...
plt.figure(figsize=(10,7))
points, = plt.plot(df_paar_tag_13['Strahlung'],df_paar_tag_13['r_photo'],'.',markersize=3) # Points definieren fuer interaktive Graphik
plt.tick_params(axis='both',labelsize=15)
...
def on_add(sel):
    i = sel.index
    x_val = df_paar_tag_13['Strahlung'].iloc[i]
    y_val = df_paar_tag_13['r_photo'].iloc[i]
    t_val = df_paar_tag_13['Zeit_mittel'].iloc[i]   # Info Zeitstempel zum Datenpunkt
...
# Plot mit linearer Regression erstellen
plt.figure(figsize=(9,6))
points, = plt.plot(df_paar_nacht_2['Saettigungsdefizitmittelwert'],df_paar_nacht_2['r_tot'],'.',markersize=3) # Points defnieren fuer interaktive Graphik
plt.plot(x,y,label=f'Regression: y = {k2:.2e}x + {r_zehr:.2e}',color='purple')
plt.tick_params(axis='both',labelsize=13) 
...
def on_add(sel):
    i = sel.index
    x_val = df_paar_nacht_2['Saettigungsdefizitmittelwert'].iloc[i]
    y_val = df_paar_nacht_2['r_tot'].iloc[i]
    t_val = df_paar_nacht_2['Zeit_mittel'].iloc[i]   # Info Zeitstempel zum Datenpunkt
...
plt.figure(figsize=(10,7))
points, = plt.plot(df_paar_tag_2['Strahlung'],df_paar_tag_2['r_photo'],'.',markersize=3) # Points defnieren fuer interaktive Graphik
plt.tick_params(axis='both',labelsize=15) 
...
def on_add(sel):
    i = sel.index
    x_val = df_paar_tag_2['Strahlung'].iloc[i]
    y_val = df_paar_tag_2['r_photo'].iloc[i]
    t_val = df_paar_tag_2['Zeit_mittel'].iloc[i]   # Info Zeitstempel zum Datenpunkt
...
# Plot mit linearer Regression erstellen
plt.figure(figsize=(9,6))
points, = plt.plot(df_paar_nacht_3['Saettigungsdefizitmittelwert'],df_paar_nacht_3['r_tot'],'.', markersize=3) # Points definieren fuer interaktive Graphik
plt.plot(x,y,label=f'Regression: y = {k2:.2e}x + {r_zehr:.2e}',color='purple')
plt.tick_params(axis='both',labelsize=13) 
...
def on_add(sel):
    i = sel.index
    x_val = df_paar_nacht_3['Saettigungsdefizitmittelwert'].iloc[i]
    y_val = df_paar_nacht_3['r_tot'].iloc[i]
    t_val = df_paar_nacht_3['Zeit_mittel'].iloc[i]   # Info Zeitstempel zum Datenpunkt
...
# Tagesdaten mit Unsicherheitsbereichen plotten
plt.figure(figsize=(10,7))
points, = plt.plot(df_paar_tag_3['Strahlung'],df_paar_tag_3['r_photo'],'.',markersize=3) # Points definieren fuer interaktive Graphik
plt.tick_params(axis='both', labelsize=15) 
...
def on_add(sel):
    i = sel.index
    x_val = df_paar_tag_3['Strahlung'].iloc[i]
    y_val = df_paar_tag_3['r_photo'].iloc[i]
    t_val = df_paar_tag_3['Zeit_mittel'].iloc[i]   # Info Zeitstempel zum Datenpunkt
