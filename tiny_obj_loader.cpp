...
namespace tinyobj {
    ...
    exportFaceGroupToShape(
        ...
        for (size_t i = 0; i < faceGroup.size(); i++) {
            ...
            for (size_t k = 2; k < npolys; k++) {
                ...
                unsigned int v0 = updateVertex(vertexCache, positions, normals, texcoords, in_positions, in_normals,
                                               in_texcoords, i0);
                unsigned int v1 = updateVertex(vertexCache, positions, normals, texcoords, in_positions, in_normals,
                                               in_texcoords, i1);
                unsigned int v2 = updateVertex(vertexCache, positions, normals, texcoords, in_positions, in_normals,
                                               in_texcoords, i2);
    ...
    std::string LoadMtl(
        ...
        while (inStream.peek() != -1) {
            ...
            if (_space) {
                unsigned long int len = (unsigned long int) _space - (unsigned long int) token;
