...
parameter.gui.import.quelle = 'diagnose.csv';

%Element 2: look for subdirectories: 1 yes, 0 no
parameter.gui.import.ordner_rekursiv = 0;

% trennzeichen =   1: None, 2:7: strvcat(' ', '_', '-', sprintf('\t'), ';', ',');
...
parameter.gui.import.inhalt = 2;

%Element 13: File extension
parameter.gui.import.dateiendung = '.csv';
...
% 'Read row by row|Write copy and read again|Normal mode|Standard ASCII|Structured'
parameter.gui.import.importfct = 5;
...
%keyboard;
datei = 'diagnose_import';

%%%%%%%%%%%%%%%%%DO NOT CHANGE THIS PART%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%import from file
eval(gaitfindobj_callback('MI_Import_Datei'));
